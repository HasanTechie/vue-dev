...
export default {
    getHotels(city = 'All') {
        return apiClient.get('/hotels&get=50' + this.getApiKey() + '&city=' + city)
    },
    getPrices() {
    ...
    getCompetitorAvgPricesForDates(competitorsids, dateOne, dateTwo) {
        return apiClient.get('competitorsavgprices&get=50' + this.getApiKey() + '&hotelid=21&datefrom=' + dateOne + '&dateto=' + dateTwo + '&competitorsid=' + competitorsids)
    },
    getCompetitorPricesApex(hotelid, competitorsids, selectedValue, dateOne = '2019-01-01', dateTwo = '2021-01-01') {
        return apiClient.get('competitorspricesapex&get=50' + this.getApiKey() + '&hotelid=' + hotelid + '&datefrom=' + dateOne + '&dateto=' + dateTwo + '&competitorsid=' + competitorsids + '&room=' + selectedValue)
    },
    getCompetitorRoomsPrices(competitorsids='1024,3045,4106', hotelid='21') {
        return apiClient.get('competitorsroomsprices&get=50' + this.getApiKey() + '&hotelid='+hotelid+'&datefrom=2019-04-25&dateto=2020-05-28&competitorsid=' + competitorsids)
    },
    ...
    getEvents(city = 'Berlin') {
        return apiClient.get('events&get=50' + this.getApiKey() + '&city=' + city)
    },
    getApiKey() {

...
export default {
    ...
    getCompetitorRoomsPrices(competitorsids, hotelid) {
        return apiClient.get('competitorsroomsprices&get=0' + this.getApiKey() + '&hotelid='+hotelid+'&datefrom=2019-04-25&dateto=2019-12-28&competitorsid=' + competitorsids)
    },
    getCompetitors() {
